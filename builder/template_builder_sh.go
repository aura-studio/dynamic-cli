...
cp -rf {{.House}}/{{.Name}}/libgo_{{.Name}}.so {{.House}}/{{.Name}}/libgo_{{.Name}}.so.$(date "+%Y%m%d%H%M%S")-{{.Version}}
cp -rf {{.House}}/{{.Name}}/libcgo_{{.Name}}.so {{.House}}/{{.Name}}/libcgo_{{.Name}}.so.$(date "+%Y%m%d%H%M%S")-{{.Version}}
`
